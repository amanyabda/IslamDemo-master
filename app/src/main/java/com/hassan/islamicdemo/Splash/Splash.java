...
import com.hassan.islamicdemo.Activiteis.Congratulation;
import com.hassan.islamicdemo.Activiteis.FirstScreen;
import com.hassan.islamicdemo.Activiteis.Images_Recycler;
import com.hassan.islamicdemo.Activiteis.Page_two;
...
public class Splash extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        new Handler().postDelayed(() -> {
            startActivity(new Intent(Splash.this, Congratulation.class));
            finish();
        },    1000);
    }
}